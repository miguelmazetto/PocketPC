...
public class Term extends Activity implements UpdateCallback, SharedPreferences.OnSharedPreferenceChangeListener, View.OnClickListener {
    ...
    private static final String PERMISSION_PATH_BROADCAST = "mmz.pocketpc.term.permission.APPEND_TO_PATH";
    private static final String PERMISSION_PATH_PREPEND_BROADCAST = "mmz.pocketpc.term.permission.PREPEND_TO_PATH";
    ...
    protected static TermSession createTermSession(Context context, TermSettings settings, String initialCommand, String _mShell) throws IOException {
        ...
        GenericTermSession session = new ShellTermSession(settings, initialCommand, _mShell, null);  // called from intents
